...
def main():
    ...
    files_handler = MessageHandler(Filters.video | Filters.document, fileshandler, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True) # AUTO_DOWN_TG
