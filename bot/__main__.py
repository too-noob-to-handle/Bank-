...
def main():
    ...
    files_handler = MessageHandler(fileshandler, Filters.video | Filters.document, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True) # AUTO_DOWN_TG
